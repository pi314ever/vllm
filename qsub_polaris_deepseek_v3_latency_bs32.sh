...
#
# =============================================================================
# PBS Pro wrapper: DeepSeek-V3 offline latency benchmark, batch size 32
# =============================================================================
#
...
#
# Submit:
#   qsub qsub_polaris_deepseek_v3_latency_bs32.sh
#
# Submit-time overrides (qsub -v):
#   qsub -v LATENCY_IO_CONFIGS_CSV=512:128,1024:4096 qsub_polaris_deepseek_v3_latency_bs32.sh
#
# =============================================================================
...
export BATCH_SIZES_CSV="${BATCH_SIZES_CSV:-32}"
